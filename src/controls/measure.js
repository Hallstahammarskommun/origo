...
const Measure = function Measure({
  ...
  function enableInteraction() {
    ...
    if (fragmentIdentifier === 'intern') {
      const interactionLogURL = 'https://karta.hallstahammar.se/fmejobsubmitter/Karttjanst/tracker%20interaction.fmw?obj=Measurement&typ=&opt_showresult=false&opt_servicemode=sync';
